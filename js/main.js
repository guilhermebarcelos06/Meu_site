...
const translations = {
  pt: {
    ...
    hero_subtitle: "Estudante de Engenharia de Software na UCB focado em construir aplicações de alta performance e bases computacionais sólidas in qualquer área.",
    hero_cta: "Entre em contato",
    hero_cv: "📄 Visualizar Currículo Premium",
    modal_title: "Visualização do Currículo Premium",
  ...
  en: {
    ...
    hero_cv: "📄 View Premium Resume",
    modal_title: "Premium Resume Preview",
